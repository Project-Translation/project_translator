...
```mermaid
sequenceDiagram
  Colaborador->>Project Translator: Crear incidencia de traducción
  Project Translator->>Comunidad: Revisar incidencia
  ...
  Colaborador->>Project Translator: Crear Pull Request, modificar README.Samples
