...
```mermaid
sequenceDiagram
  Contributor->>Project Translator: Créer une issue de traduction
  Project Translator->>Community: Examiner l'issue
  Community-->>Contributor: Approuver/Commenter
  Contributor->>New Project: Commencer la traduction
  Contributor->>New Project: Soumettre au Nouveau Projet
  Contributor->>Project Translator: Créer une Pull Request, modifier README.Samples
  Project Translator-->>Project Translator: Examiner & Fusionner
```
